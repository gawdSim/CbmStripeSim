...
{
	coupleRiRjRatioIO          = std::stof(s_file.parsed_var_sections["activity"].param_map["coupleRiRjRatioIO"]); 
	eBCtoPC                    = std::stof(s_file.parsed_var_sections["activity"].param_map["eBCtoPC"]); 
	eNCtoIO                    = std::stof(s_file.parsed_var_sections["activity"].param_map["eNCtoIO"]); 
	ePCtoBC                    = std::stof(s_file.parsed_var_sections["activity"].param_map["ePCtoBC"]); 
	ePCtoNC                    = std::stof(s_file.parsed_var_sections["activity"].param_map["ePCtoNC"]); 
	eSCtoPC                    = std::stof(s_file.parsed_var_sections["activity"].param_map["eSCtoPC"]); 
	...
	gDecT0ofNCtoIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecT0ofNCtoIO"]); 
	gDecTSofNCtoIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTSofNCtoIO"]); 
	gDecTTofNCtoIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTTofNCtoIO"]); 
	gIncNCtoIO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncNCtoIO"]); 
	gIncTauNCtoIO              = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncTauNCtoIO"]); 
	gDecTauPCtoBC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauPCtoBC"]); 
	gDecTauPCtoNC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauPCtoNC"]); 
	gIncAvgPCtoNC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncAvgPCtoNC"]); 
	gDecTauGRtoBC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauGRtoBC"]); 
	gDecTauGRtoPC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauGRtoPC"]); 
	gDecTauGRtoSC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauGRtoSC"]); 
	gIncGRtoPC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGRtoPC"]); 
	gDecTauSCtoPC              = std::stof(s_file.parsed_var_sections["activity"].param_map["gDecTauSCtoPC"]); 
	gIncSCtoPC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncSCtoPC"]);  
	synLTDStepSizeGRtoPC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTDStepSizeGRtoPC"]); 
	synLTPStepSizeGRtoPC       = std::stof(s_file.parsed_var_sections["activity"].param_map["synLTPStepSizeGRtoPC"]); 
	maxExtIncVIO               = std::stof(s_file.parsed_var_sections["activity"].param_map["maxExtIncVIO"]); 
	msLTDDurationIO            = std::stof(s_file.parsed_var_sections["activity"].param_map["msLTDDurationIO"]); 
	msLTDStartAPIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["msLTDStartAPIO"]); 
	msLTPEndAPIO               = std::stof(s_file.parsed_var_sections["activity"].param_map["msLTPEndAPIO"]); 
	msLTPStartAPIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["msLTPStartAPIO"]); 
	msPerHistBinGR             = std::stof(s_file.parsed_var_sections["activity"].param_map["msPerHistBinGR"]); 
	relPDecT0ofNCtoIO          = std::stof(s_file.parsed_var_sections["activity"].param_map["relPDecT0ofNCtoIO"]); 
	relPDecTSofNCtoIO          = std::stof(s_file.parsed_var_sections["activity"].param_map["relPDecTSofNCtoIO"]); 
	relPDecTTofNCtoIO          = std::stof(s_file.parsed_var_sections["activity"].param_map["relPDecTTofNCtoIO"]); 
	relPIncNCtoIO              = std::stof(s_file.parsed_var_sections["activity"].param_map["relPIncNCtoIO"]); 
	relPIncTauNCtoIO           = std::stof(s_file.parsed_var_sections["activity"].param_map["relPIncTauNCtoIO"]); 
	gIncPCtoBC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncPCtoBC"]); 
	gIncGRtoBC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGRtoBC"]); 
	gIncGRtoSC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["gIncGRtoSC"]); 
	rawGLeakBC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakBC"]); 
	rawGLeakGR                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakGR"]); 
	rawGLeakIO                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakIO"]); 
	rawGLeakNC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakNC"]); 
	rawGLeakPC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakPC"]); 
	rawGLeakSC                 = std::stof(s_file.parsed_var_sections["activity"].param_map["rawGLeakSC"]); 
	threshDecTauBC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauBC"]); 
	//threshDecTauGR             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauGR"]); 
	threshDecTauIO             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauIO"]); 
	threshDecTauNC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauNC"]); 
	threshDecTauPC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauPC"]); 
	threshDecTauSC             = std::stof(s_file.parsed_var_sections["activity"].param_map["threshDecTauSC"]); 
	threshMaxBC                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxBC"]); 
	//threshMaxGR                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxGR"]); 
	threshMaxIO                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxIO"]); 
	threshMaxNC                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxNC"]); 
	threshMaxPC                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxPC"]); 
	threshMaxSC                = std::stof(s_file.parsed_var_sections["activity"].param_map["threshMaxSC"]); 
	//weightScale                = std::stof(s_file.parsed_var_sections["activity"].param_map["weightScale"]); 
